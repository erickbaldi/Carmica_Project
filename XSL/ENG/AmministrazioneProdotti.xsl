...
<html>
<head>
<title>Product Amministration</title>      
...
<div class="T2">
     ...
     <span class="stile">
       ...
       <input type="submit" name="s" class="stile" value="LOOK!"/><br/><br/><br/>
            <xsl:if test="//tipo_attivo='C'">
            </xsl:if>     
   
    <a href="javascript:inserimentoProdotto()"><span class="fire">New product</span></a><BR/><br/><br/><br/><br/><br/><br/>
    </span>
</form> 
</div>
...
<div class= "T8">       
 <table border="1">
    <tr bgcolor="red">
        <td> <span class="elementiTabella"> Name </span> </td>
        <xsl:choose>
        <xsl:when test="//tipo_attivo='M'"></xsl:when>
        <xsl:otherwise>
        <td> <span class="elementiTabella"> Description </span> </td>
        </xsl:otherwise>
        </xsl:choose>
        <td> <span class="elementiTabella"> Price </span> </td>
        <td></td> 
