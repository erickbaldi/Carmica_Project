...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
    ...
    <html>
      <head>
        <title>Crea il tuo DVD personalizzato</title>
	...
	<script language="javascript">
        ...
        function calcolaprezzo(){
            ...
            radiobutton();
            checkbutton();
            alert("Il tuo DVD attuale costa: "+prezzo+" euro");}   
  ...
  function insertDVD() 
          ...
          if (isEmpty(f.nome_DVD.value)) 
            { alert("Inserisci un nome per il DVD creato da te!");
              return;
              }      
...
<div class="T6"> 
  <span class="fire" align="center">CREA IL TUO DVD!</span> 
      <form name="insertForm" action="Basket.jsp" method="post">
             <span class="stile" >
                 ...
                 Tipo
                 <br/><br/>
                 <input type="radio" name="tipo_DVD" value="DVDspecial" checked="checked" /> DVD con copertina e serigrafia a colori
                 <br/>
                 <input type="radio" name="tipo_DVD" value="DVDbase"/> DVD base (solo custodia)
                 <br/><br/><hr/><br/>
                ...
                <input type="button" value="invia" class="stile"  onClick="insertDVD()"/>
...
<div class="T2">  
       ...
       <br/><br/>
       Scegli un nome per il tuo DVD.
       <br/><br/><br/><br/><br/><br/>
       Poi scegli se il DVD lo vuoi con copertina (3 euro) o senza (solo custodia protettiva).
       <br/><br/><br/><br/><br/><br/>
       Ora aggiungi i video che vuoi dalla tabella 
       <br/><br/>
       Scegli con cura perche' ne puoi mettere massimo 4
       <br/><br/>
       Ogni video costa 3 euro.
       <br/> <br/> <br/> <br/>
