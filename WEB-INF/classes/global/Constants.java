...
public class Constants {
  ...
  /** Constants for db connection */                //jdbc:odbc:carmica
  public static final String DB_CONNECTION_STRING = "jdbc:odbc:carmica";
  public static final String DB_USER_NAME         = "admin";//admin
  public static final String DB_PASSWORD          = "admin";//admin
